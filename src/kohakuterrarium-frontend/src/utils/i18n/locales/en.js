export default {
  ...
  "sessionViewer.trace.timeline.modeHint.sequence": "Sequence: every event is one equal-width block in operation order — ignores clock time, best for seeing what happened and in what order.",
  "sessionViewer.trace.timeline.modeHint.duration": "Duration: real start time + real duration per event, with idle gaps between events compressed away — best for spotting slow steps.",
  "sessionViewer.trace.timeline.modeHint.time": "Time: real start times with idle gaps compressed, but every event equal width — best for seeing event density over time without long steps stretching the view.",
  "sessionViewer.trace.timeline.modeHint.actual": "Actual: the true wall-clock timeline, idle gaps kept — best for seeing where the session waited or idled.",
  ...
  "sessionViewer.trace.timeline.hint": "Drag to focus an interval · wheel to zoom · right-drag to pan · double-click to reset",
  "sessionViewer.trace.timeline.minimapHint": "Overview of the full session · click or drag to move the zoomed viewport",
  "sessionViewer.trace.timeline.truncated": "latest only",
  "sessionViewer.trace.timeline.truncatedHint": "Session has more events than the overview limit — only the most recent are shown.",
