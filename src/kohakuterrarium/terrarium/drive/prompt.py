...
_GENERIC_CONTRACT = (
    ...
    "someone else and assigned to you permits reports/proposals and these controls: "
    "active to waiting, waiting to active when the awaited work is ready, and "
    "active/waiting to blocked (use 'blocked' when you need user intervention). "
    "Do not cancel, reassign, retire, pause, or resume paused/blocked drives.\n"
